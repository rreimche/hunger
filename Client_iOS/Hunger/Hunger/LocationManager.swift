...
class LocationManager: NSObject, CLLocationManagerDelegate, ObservableObject {
    ...
    var defaultStartingLocation = CLLocation(latitude: 0, longitude: 0)
    ...
    func startUpdatingLocations(){
        ...
        self.circleQuery = self.geoFire.query(at: lastKnownLocation ?? defaultStartingLocation, withRadius: 1)
